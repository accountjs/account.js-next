...
import { NotPromise, packUserOp } from './encode'
...
export type PreVerificationOp = PartialBy<
  NotPromise<UserOperationStruct>,
  'signature' | 'preVerificationGas' | 'maxFeePerGas' | 'maxPriorityFeePerGas'
>
