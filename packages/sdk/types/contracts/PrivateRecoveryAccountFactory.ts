...
export interface PrivateRecoveryAccountFactoryInterface
...
export interface PrivateRecoveryAccountFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PrivateRecoveryAccountFactoryInterface;
