...
export interface IUpdateGuardianVerifierInterface extends utils.Interface {
  functions: {
...
export interface IUpdateGuardianVerifier extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IUpdateGuardianVerifierInterface;
